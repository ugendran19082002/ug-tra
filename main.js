...
async function main() {
    ...
    while (true) {
        ...
        try {
            ...
            const liveTo = "2026-03-02 09:45"; // ✅ FIX: replace with formatDateTime() for real live use
